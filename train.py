...
def get_args():
    ...
    parser.add_argument('--use-clip', type=bool, default=False, help='Whether or not to use CLIP')
    parser.add_argument('--use-cloob', type=bool, default=False, help='Whether or not to use CLOOB')
    parser.add_argument('--pretrain-atom-only', type=bool, default=False, help='Whether or not to train on atom properties only.')
    parser.add_argument('--pretrain-mol-only', type=bool, default=False, help='Whether or not to train on mol properties only.')

    parser.add_argument('--transfer-learning', type=bool, default=False, help='Whether or not to use transfer learning after pre-training')
    parser.add_argument('--fine-tuning', type=bool, default=False, help='Whether or not to use transfer learning after pre-training')

    parser.add_argument('--pretraining-ckpt', type=str, default=None, help='Include path of pretrained model checkpoint!')
